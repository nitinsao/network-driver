...
static void snull_hw_tx(char *buf, int len, struct net_device *dev)
{
	...
	printk(KERN_ALERT "src : %d.%d.%d.%d = %d", ((u8 *)saddr)[0], ((u8 *)saddr)[1], ((u8 *)saddr)[2], ((u8 *)saddr)[3], saddr);
	printk(KERN_ALERT "dest : %d.%d.%d.%d = %d", ((u8 *)daddr)[0], ((u8 *)daddr)[1], ((u8 *)daddr)[2], ((u8 *)daddr)[3], daddr);
	...
	ih->saddr = ih->daddr;
	ih->daddr = temp_addr;
	printk(KERN_ALERT "new src : %d.%d.%d.%d = %d", ((u8 *)saddr)[0], ((u8 *)saddr)[1], ((u8 *)saddr)[2], ((u8 *)saddr)[3], saddr);
	printk(KERN_ALERT "new dest : %d.%d.%d.%d = %d", ((u8 *)daddr)[0], ((u8 *)daddr)[1], ((u8 *)daddr)[2], ((u8 *)daddr)[3], daddr);
